...
**Group 2 ([Snack Clock]([https://github.com/rohilsaraf97/Interactive-Lab-Hub/blob/Fall2026/Lab%202/README.md))** — Such a fun idea!! and the sketch is clean and easy to follow. One thing: figure out how long each stage lasts (an hour? a day?), otherwise it's more of a cool animation than an actual clock.
